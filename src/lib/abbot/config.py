...
BOT_TELEGRAM_HANDLE = f"test_{BOT_TELEGRAM_HANDLE}" if DEV_MODE else BOT_TELEGRAM_HANDLE
BOT_TELEGRAM_TOKEN = f"test_{BOT_TELEGRAM_TOKEN}" if DEV_MODE else TEST_BOT_TELEGRAM_HANDLE
