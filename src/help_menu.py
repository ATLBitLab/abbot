...
2. /summary
    ...
    Arguments:
        None (default) ⇒ produce daily summaries for the past 7 days
        <date> ⇒ produce summary for date (e.g. /summary 2023-07-05)
        <start_date> <end_date> ⇒ produce daily summaries from <start_date> to <end_date> (e.g. /summary 2023-07-02 2023-07-05)
        <start_date> <number_of_days> ⇒ produce daily summaries from <start_date> to <number_of_days> in future (e.g. /start `2023-07-02` `2` ⇒ summary of 07-02, 07-03)
3. /clean
