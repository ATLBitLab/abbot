...
from lib.utils import sender_is_group_admin, try_except, try_get
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        abbot: GPT = try_get(abbots, chat_id)
        if not abbot:
            abbot: GPT = GPT(f"{bot_context}{BOT_NAME}{chat_id}", BOT_HANDLE, ATL_BITCOINER, bot_context, chat_id)
