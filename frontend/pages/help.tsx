    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="Helpful bitcoiner bot from Atlanta built by ATL BitLab. Est. block 797812."
        />
      ...
      <main
        className={
          spacemono.className +
          " mx-auto max-w-5xl text-white flex flex-col items-center gap-2 my-16 pb-16"
        }
      >
        ...
        <br></br>
        <h3>How to Fund Abbot with Lightning</h3>
        <ul>
          <li>
        ...
        <h3>General Tips for Using Abbot</h3>
        <ul>
          <li>
            Use specific commands like /help to get assistance on various
            features.
          </li>
          <li>
          ...
          <li>
            For real-time assistance or feedback, use the /feedback command.
          </li>
        </ul>
        <br />
